                ...
                <div className="p-grid" >
                    <div className="p-col">
                        <div className="p-d-flex">
                            <div className="p-mx-auto p-px-auto p-order-1" style={{height: '100px', width: '150px'}}>
                                <img src={IconOne} alt="" className="services-item" />
                                <p className="services-desc">Integrable</p>
                            </div>
                            <div className="p-mx-auto p-order-2" style={{height: '100px', width: '150px'}}>
                                <img src={IconTwo} alt="" className="services-item" />
                                <p className="services-desc">Reportes</p>
                            </div>
                            <div className="p-mx-auto p-order-3" style={{height: '100px', width: '150px'}}>
                                <img src={IconThree} alt="" className="services-item" />
                                <p className="services-desc">Ux Design</p>
                            </div>
                        </div>
                        <div className="p-d-flex">
                            <div className="p-mx-auto p-order-1" style={{height: '100px', width: '150px'}}>
                    ...
                    <div className="p-col">
                        <img src={TabletBox} alt="Sorprendeme" className="hero-image" />
                    </div>
                </div>
            </div >
