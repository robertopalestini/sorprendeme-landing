                ...
                <div class="p-d-md-none">
                    ...
                    <div className="grid grid-rows-2 grid-flow-col" style={{backgroundColor:"#f4f6fa"}}>
                        ...
                        <div className="col-span-2 flex">
                            ...
                            <div>
                                <h3>Encontrá</h3>
                                <p className="services-p">Toda la información de manera efectiva con este gestor y repositorio de documentos.</p>
                            </div>
                        </div>
                        ...
                        <div className="col-span-2 flex">
                            ...
                            <div>
                                <h3>Optimizá</h3>
                                <p className="services-p">Optimizá procesos, reducí costos y mantené tu información segura.</p>
                            </div>
                        </div>
